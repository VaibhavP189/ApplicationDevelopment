...
public class PlanetExplorer {
	...
	public static void main (String [] args) {
		// Display a title for this program on the console.	
		System.out.println("Planet Explorer");
		System.out.println("     by: Vaibhav");
		...
		System.out.println("   on Mercury: " + mass.format(massWeightOnJupiter) + " Kilograms");
